      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="logo mb-4 md:mb-0">
            <Link href="/" className="text-2xl font-bold text-blue-600">Deveza Research and Projects</Link>
          </div>
          <nav>
            <ul className="flex flex-wrap justify-center gap-1 md:gap-6">
              <li><Link href="/" className="px-3 py-2 text-blue-600 hover:text-blue-800 transition-colors">Home</Link></li>
              <li><Link href="/news" className="px-3 py-2 text-blue-600 hover:text-blue-800 transition-colors">News</Link></li>
              <li><Link href="/publications" className="px-3 py-2 text-blue-600 hover:text-blue-800 transition-colors">Publications</Link></li>
